        ...
        <div key={idx} className="p-4 border border-border rounded-xl bg-white hover:bg-gray-50 transition-colors shadow-sm group">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 self-end sm:self-center">
              {activity.status === 'successful' || activity.status === 'Successful' ? (
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 bg-red-50 text-red-600 rounded-full text-xs font-semibold border border-red-100">
